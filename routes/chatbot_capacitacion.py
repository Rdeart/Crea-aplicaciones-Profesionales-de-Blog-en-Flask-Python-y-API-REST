...
N8N_TRAINING_WEBHOOK = os.getenv('N8N_TRAINING_WEBHOOK', '/webhook/8dedf731-b9cb-46db-b235-df3b1c9e3be0/chat')
...
def chat_capacitacion_route():
    ...
    if not messages:
        ...
        return jsonify({'reply': '¡Hola! Soy tu Instructor Digital Experto para Cure LATAM. Estoy aquí para capacitarte en Natrox, Endoform, Pretiva y Myriad Matrix. ¿Qué te gustaría aprender hoy?'})
    else:
    ...
    return _call_n8n_and_respond(api_messages, chat_type='training')
